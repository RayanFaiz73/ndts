                                                    ...
                                                    @if (count($menu->childrenMenus))
                                                        <tr>
                                                            <th colspan="5" scope="col"
                                                                class="px-6 pt-3 text-base font-bold text-theme-secondary-100 dark:text-white decoration-theme-primary-500">
                                                                {{ $menu->name }}
                                                                <span class="text-theme-secondary-100 text-xs">(Parent)</span>
                                                            </th>
                                                        </tr>
                                                    ...
                                                    {{-- <tr class="bg-theme-primary-700 dark:bg-gray-800">
                                                        <th scope="row"
                                                            ...
                                                            <label
                                                                ...
                                                                <span
                                                                    class="ml-3 text-sm font-medium text-theme-secondary-100 dark:text-gray-300">{{ $menu->name }}</span>
                                                            </label>
                                                        </th>
                                                        <td class="px-6 py-2 ">
                                                            <div class="d-flex justify-center">
                                                                <label
                                                                    ...
                                                                    <span
                                                                        class="ml-3 text-sm font-medium text-theme-secondary-100 dark:text-gray-300"></span>
                                                                </label>
                                                            </div>
                                                        </td>
                                                        <td class="px-6 py-2 ">
