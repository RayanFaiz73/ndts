            ...
            <div
                ...
                <div class="p-6 text-theme-secondary-100">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="w-full" action="{{ route('admin.data-operator.update',$staff->id) }}" method="POST"
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    ...
                                    <div class="w-full lg:w-2/2 px-3 mb-6 lg:mb-3" id="parent_id_div">
                                        ...
                                        <select required name="parent_id" id="parent_id"
                                            ...
                                            <option value="{{ $hospital->id }}" @if ($hospital->id == $staff->parent_id)selected @endif>{{ $hospital->data_name}}</option>
                                            @endforeach
                                        </select>
                                        @error('parent_id')
                                        <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
