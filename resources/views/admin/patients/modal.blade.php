                    ...
                    <div class="card-body">
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-6">
                                ...
                                <p class="text-md">{{$patient->sex == 'male' ? 'Male' : 'Female'}}</p>
                                @error('phone')
                                <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-6">
                                ...
                                <p class="text-md">{{$patient->diagnose->diagnose}}</p>
                                @error('nic')
                                <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-6">
                                ...
                                <p class="text-md">{{$patient->staff->name}}</p>
                                @error('nic')
                                <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-6">
                                ...
                                <p class="text-md">{{$patient->hospital->data_name}}</p>
                                @error('nic')
                                <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full lg:w-1/2 px-3 mb-6 lg:mb-6">
                                ...
                                <p class="text-md">{{$patient->address}}</p>
                                @error('nic')
                                <p class="text-theme-danger-500 text-xs italic">{{ $message }}</p>
                                @enderror
                            </div>
