<x-app-layout>
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="max-w-xl w-full bg-theme-primary-700 rounded-lg shadow dark:bg-gray-800 p-4 md:p-6"
                    ...
                    <div class="grid grid-cols-2 py-3">
                        ...
                        <dl>
                            <dt class="text-base font-normal text-theme-secondary-100 dark:text-gray-400 pb-1">Female</dt>
                        ...
                        <div class="grid grid-cols-3 gap-3 mb-2">
                            <dl
                                ...
                                <dt id="disease_maleCount"
                                    ...
                                    0</dt>
                                <dd class="text-orange-600 dark:text-orange-300 text-sm font-medium">Male</dd>
                            </dl>
                            <dl
                                class="bg-theme-primary-400 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                <dt id="disease_femaleCount"
                                    ...
                                    0</dt>
                                <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Female</dd>
                            </dl>
                            <dl
                                class="bg-theme-primary-400 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#province_id_div .nice-select-search, #disease_id_div .nice-select-search, #diseases_id_div .nice-select-search").keyup(function() {
                console.log(this)
...
$(document).ready(function () {
        ...
        diseaseDataToController();
        }
        });

    function diseaseDataToController() {
            $.ajax({
