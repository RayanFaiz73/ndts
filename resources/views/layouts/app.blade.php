...
{{-- <link href="{{ asset('assets/site/css/jquery.data.min.css') }}" rel="stylesheet" /> --}}
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-theme-primary-500 dark:bg-gray-900">
        <div class="flex ">
            <aside class="w-96 min-h-screen hidden lg:block sm:min-h-full bg-theme-primary-700 dark:bg-gray-800 shadow-lg "
                aria-label="Sidebar">
                <div class="sticky top-0 z-10 px-3 min-h-screen overflow-y-auto">
                    <div
                        ...
                        {{-- <a href="{{ route('dashboard') }}"> --}}
                            {{-- <x-application-logo
                                class="block w-auto fill-current text-gray-400 dark:text-gray-200 rounded-xl" /> --}}
                            {{-- <x-application-logo
                                class="block h-12 w-auto fill-current text-gray-400 dark:text-gray-200 rounded-xl" />
                    ...
                    {{-- <div
                        class="w-48 justify-center mb-4 h-16 border-t bottom-0 absolute border-gray-100 dark:border-gray-700">
                        <!-- Authentication -->
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
