...
(function ($) {
    ...
    AIZ.uploader = {
                                ...
                                $.ajax({
                                    ...
                                    success: function () {
                                        ...
                                        AIZ.uploader.getAllUploads(
                                            AIZ.data.appUrl +
                                                "/admin/aiz-uploader/get_uploaded_files"
                                        );
                                        AIZ.uploader.data.clickedForDelete =
                                            null;
        ...
        showSelectedFiles: function () {
            $('[name="aiz-show-selected"]').on("change", function () {
                if ($(this).is(":checked")) {
                    ...
                    // }
                    AIZ.uploader.getAllUploads(
                        AIZ.data.appUrl + "/admin/aiz-uploader/get_uploaded_files"
                    );
                }
                AIZ.uploader.updateUploaderFiles();
            });
            ...
            setTimeout(function () {
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var html =
                            '<div class="card file-manager-item file aiz-file-box-wrap" aria-hidden="' +
                            data[i].aria_hidden +
                            '" data-selected="' +
                            data[i].selected +
                            '">' +
                            '<div class="card-img-top file-logo-wrapper aiz-file-box">' +
                            ...
                            data[i].id +
                            '">' +
                            '<div class="d-flex align-items-center justify-content-center w-100 card-file-thumb">' +
                            thumb +
                            "</div>" +
                            '<div class="card-body">' +
                            '<h6 class="d-flex">' +
        ...
        trigger: function (
            ...
            // setTimeout(function() {
            $.post(
                AIZ.data.appUrl + "/admin/aiz-uploader",
                { _token: AIZ.data.csrf },
                function (data) {
                    $("body").append(data);
                    setTimeout(() => {
        ...
        previewGenerate: function () {
            $('[data-toggle="aizuploader"]').each(function () {
                ...
                if (files != "") {
                    $.post(
                        AIZ.data.appUrl + "/admin/aiz-uploader/get_file_by_ids",
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.use(Uppy.XHRUpload, {
                    endpoint: AIZ.data.appUrl + "/admin/aiz-uploader/upload",
                    fieldName: "aiz_file",
                    formData: true,
                    headers: {
